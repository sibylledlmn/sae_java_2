<aside class="sidebar" aria-label="Navigation principale">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="/client/dashboard" class="nav-item ${pageActive == 'dashboard' ? 'active' : ''}" ${pageActive == 'dashboard' ? 'aria-current="page"' : ''}>
        ...
        <a href="/client/contrats" class="nav-item ${pageActive == 'contrats' ? 'active' : ''}" ${pageActive == 'contrats' ? 'aria-current="page"' : ''}>
        ...
        <a href="/client/factures" class="nav-item ${pageActive == 'factures' ? 'active' : ''}" ${pageActive == 'factures' ? 'aria-current="page"' : ''}>
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg>
            Mes factures
        </a>
        <a href="/client/consommation" class="nav-item ${pageActive == 'consommation' ? 'active' : ''}" ${pageActive == 'consommation' ? 'aria-current="page"' : ''}>
        ...
        <a href="/client/profil" class="nav-item ${pageActive == 'profil' ? 'active' : ''}" ${pageActive == 'profil' ? 'aria-current="page"' : ''}>
        ...
        <a href="/client/tarifs" class="nav-item ${pageActive == 'tarifs' ? 'active' : ''}" ${pageActive == 'tarifs' ? 'aria-current="page"' : ''}>
